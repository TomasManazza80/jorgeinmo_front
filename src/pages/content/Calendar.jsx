...
const Calendar = () => {
    ...
    const EventsInSelectedRange = () => {
        return (
            <div>
                <h3>Eventos en la semana seleccionada</h3>
                <div className="flex flex-col gap-2 text-muted-foreground">
                    ...
                    {eventsInRange.length === 0 && <div>No hay eventos.</div>}
                </div>
                </div>
        )
    }
                ...
                <div className="flex flex-col gap-2 w-fit">
                    ...
                    <Accordion type="multiple" collapsible={true}>
                        <AccordionItem value="upcoming">
                            <AccordionTrigger>Próximos</AccordionTrigger>
                            <AccordionContent>
                                Tus tres próximos eventos son:
                                <UpcomingEvents/>
                            </AccordionContent>
                        </AccordionItem>
