        ...
        <>
            ...
            <div className="flex flex-col gap-4">
                <p className={"text-gray-500"}>
                    Esta página ofrece un resumen de las finanzas para una propiedad específica o todas las propiedades, dependiendo de tu selección.
                </p>

                <div className="flex flex-row flex-wrap gap-4">
                    <InfoCard title="Renta Pendiente" number={moneyParser(rentDue)}  />
                    <InfoCard title="Renta Pagada" number={moneyParser(rentPaid)}  />
                    <InfoCard title="Contratos Activos" number={activeLeases}   />
                </div>
