                    ...
                    return (
                        ...
                        >
                            <Avatar className="w-8 h-8 rounded-full">
                                <AvatarImage src={tenant?.profileImageUrl} alt="Inquilino" className="rounded-none" />
                            ...
                            <div>
                                ...
                                <p  className="text-sm text-muted-foreground font-300">
                                    Creado el {dateParser(tenant?.createdAt)}
                                </p>
                            </div>
                        </div>
                    )
    ...
    return (
        <div className="flex flex-col">
            ...
            <p className="text-gray-500">
                Monitorea, gestiona y haz crecer tu negocio inmobiliario.
            </p>
                            ...
                            <div className="flex flex-row flex-wrap gap-x-6 gap-y-2">
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p  className="font-400 text-muted-foreground text-sm">
                                            Agrega una nueva propiedad incluyendo unidades
                                        </p>
                                    </div>
                                </div>
                                <div className="flex flex-row gap-2 items-center flex-grow bg-background-light border-2 border-border p-3 rounded-lg hover:bg-secondary select-none cursor-pointer"
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p  className="font-400 text-muted-foreground text-sm">
                                            Agrega un nuevo inquilino a una unidad
                                        </p>
                                    </div>
                                </div>
                            </div>
